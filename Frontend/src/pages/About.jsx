  ...
  return (
    <div className="bg-white py-16 px-4 sm:px-8 md:px-16 lg:px-24 text-gray-700">
      ...
      <p className="text-center text-gray-500 mb-12 max-w-xl mx-auto">
        Discover how MyDoctor is transforming healthcare through smart technology and patient-first care.
      </p>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-16">
        ...
        <div className="flex-1 space-y-6 text-sm text-gray-600">
          <p>
            <span className="font-medium text-primary">MyDoctor</span> is your trusted healthcare companion, simplifying how you access doctors and manage your health. We understand the challenges of getting timely care and maintaining your health records.
          </p>
          <p>
          ...
          <div>
            ...
            <p className="mt-2">
              We aim to revolutionize the healthcare experience—making it seamless, accessible, and patient-centric. MyDoctor is here to support your well-being, anytime, anywhere.
            </p>
          </div>
        </div>
      </div>
